...
def canonical_prompt_profile(value: str) -> str:
    ...
    try:
        ...
        raise ValueError(
            f"Unsupported LTX prompt profile: {value!r}. Choose: "
            f"{supported}."
        ) from error
...
def resolve_prompt_profile(
    ...
    *,
    ...
    if any(marker in prompt_text for marker in ltx25_markers):
        return "LTX 2.5"
    return "LTX 2.3"
...
def prompt_profile_control_block(value: str) -> str:
    ...
    if canonical == "LTX 2.3":
        return ""
    return "\n\n" + load_template("ltx25_prompt_profile.txt")
...
class PromptPipeline:
    ...
    def run(
        ...
        *,
        ...
        ltx_prompt_profile: str = "LTX 2.3",
        duration_context: DurationContext | None = None,
        ...
        if mode == "STANDARD VISION":
            ...
            return PromptPipelineResult(
                package,
                final_prompt,
                "STANDARD VISION — 1 Ollama call completed; "
        ...
        return PromptPipelineResult(
            ...
            f"{canonical_ending}; prompt profile {canonical_profile}."
        )
